...
public class UserTestData {
    ...
    public static final User ADMIN = new User(ADMIN_ID, "Admin", "admin@gmail.com", "79101451000", "admin", ROLE_ADMIN);
    ...
    public static void assertMatch(Iterable<User> actual, Iterable<User> expected) {
        assertThat(actual).usingElementComparatorIgnoringFields("registered", "roles", "company", "addresses").isEqualTo(expected);
    }
}
